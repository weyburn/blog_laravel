<div id="comments">
    @if(count($post->comments))
        <h2 class="comment-title">目前有{{ count($post->comments) }}条评论</h2>
        <ul class="comment-list">
            @foreach($post->comments as $comment)
                <li class="comment-item" id="comment-{{ $comment->id }}">
                    <div class="comment-author">
                        <img class="avatar" src="{{ asset('assets/images/commenter-pic.svg') }}" alt="commenter-pic">
    ...
    <form class="comment-form" onsubmit="return false" data-post-id="{{ $post->id }}" data-reply-id="" data-reply-name=""
    data-parsley-validate>
        ...
        <div class="form-group parsley-form-group">
            ...
            <input class="form-control" id="websiteInput" type="text" name="website" placeholder="http://"
                   data-parsley-trigger="blur"
        ...
        <div class="form-group parsley-form-group">
            ...
            <textarea class="form-control" id="contentInput" name="content" placeholder="说说你的看法" rows="10"
                      data-parsley-trigger="blur"
