CREATE DATABASE IF NOT EXISTS `cn_weyburn_blog` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
use `cn_weyburn_blog`;
...
INSERT INTO `users` (`id`, `name`, `email`, `password`, `remember_token`, `created_at`, `updated_at`, `deleted_at`) VALUES
  (1, 'weyburn', 'weyburn@126.com', '$2y$10$xk1Y2ByVLK6EYg9NJv1H0.AhH3AklmB5GGSK0ll1yYWtqKva8pYiC', 'ifJSSTg5PAsbHHqEbTKsyydWcTTcgJHtoX7Qf7JJGMJuGowu7W73l3ykBnCR', '2018-02-07 07:42:01', '2018-02-07 07:58:45', NULL);
-- --------------------------------------------------------
